...
produced F1=0.5045 (difference $-0.0045$), while replacing
deterministic reconciliation with a simple union produced
F1=0.5062 (difference $-0.0028$). These trace-level differences
...
F1=0.4736, below the archived full-system value, but exact
prompt and parser parity cannot be established. Excluding \texttt{Other} at
evaluation time produced micro F1=0.7841 and macro
F1=0.5714. Because this is evaluation-only, it does not show
...
IoG@0.5, Llama reached 0.7247 while GROVE
reached 0.6275. Thus, the raw IoG ranking changes at
